...
public interface LabTestCatalogRepository extends JpaRepository<LabTestCatalogEntry, UUID> {

    Optional<LabTestCatalogEntry> findByCodeIgnoreCase(String code);

    List<LabTestCatalogEntry> findByActiveTrueOrderByName();
}

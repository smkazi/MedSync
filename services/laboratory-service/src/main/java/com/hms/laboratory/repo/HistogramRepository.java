...
public interface HistogramRepository extends JpaRepository<HistogramRecord, UUID> {

    List<HistogramRecord> findByOrderId(UUID orderId);

    Optional<HistogramRecord> findByOrderIdAndGroupCode(UUID orderId, String groupCode);
}

...
SANS="DNS:localhost,DNS:gateway,DNS:identity-service,DNS:patient-service,DNS:scheduling-service,DNS:laboratory-service,DNS:notification-service,DNS:admissions-service,DNS:pharmacy-service,DNS:billing-service,DNS:interop-service,DNS:imaging-service,DNS:ai-service,DNS:web,IP:127.0.0.1"
